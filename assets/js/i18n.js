...
(function () {
  ...
  var I18N = {
    vi: {
      ...
      "cs.s5d": "Độ trễ 2,3 ms ở mọi quãng giọng, không phải bật chế độ nào — người hát nghe lại giọng mình gần như không trễ, dùng được cho sân khấu và livestream.",
    ...
    en: {
      ...
      "cs.s5t": "Usable live",
      "cs.s5d": "2.3 ms of latency on every voice range, with no mode to switch on — the singer hears themselves back with almost no delay, on stage or on stream.",
    ...
    zh: {
      ...
      "cs.s5t": "现场也能用",
      "cs.s5d": "任意音域均为 2.3 ms 延迟，无需切换任何模式——歌手返听几乎察觉不到延迟，舞台与直播都能用。",
      "cs.s6t": "按歌曲真实的基准音高",
