...
(function () {
  ...
  var I18N = {
    vi: {
      ...
      "hero.m1n": "4", "hero.m1": "sản phẩm",
      "hero.m2": "chi phí lúc này", "hero.m3": "nền tảng · Win / macOS",
      // products
      "products.eyebrow": "Bộ sản phẩm", "products.title": "Bốn sản phẩm. Bốn nút thắt được gỡ.",
      ...
      "dl.cs.spec": "v1.0.0 · Windows 10/11 · x64 · bộ cài (Sense + Tune, VST3) · 9.2 MB",
      ...
      "cs.tag": "Bản chính thức v1.0.0 · Windows · VST3",
      ...
      "cs.s5d": "Chế độ Low Latency dành cho sân khấu và livestream: người hát nghe lại giọng mình gần như không trễ.",
    ...
    en: {
      ...
      "hero.m1n": "5", "hero.m1": "products",
      "hero.m2": "cost right now", "hero.m3": "platforms · Win / macOS",
      "products.eyebrow": "Our products", "products.title": "Five products. Five knots unpicked.",
      ...
      "dl.cs.spec": "v1.0.0 · Windows 10/11 · x64 · installer (Sense + Tune, VST3) · 9.2 MB",
      ...
      "cs.tag": "Official release v1.0.0 · Windows · VST3",
      ...
      "cs.s5t": "Usable live",
      "cs.s5d": "Low Latency mode is for the stage and for streaming: the singer hears themselves back with almost no delay.",
    ...
    zh: {
      ...
      "hero.m1n": "4", "hero.m1": "款产品",
      "hero.m2": "费用（现阶段）", "hero.m3": "个平台 · Win / macOS",
      "products.eyebrow": "产品系列", "products.title": "四款产品，解开四个结。",
      ...
      "dl.cs.spec": "v1.0.0 · Windows 10/11 · x64 · 安装程序（Sense + Tune，VST3）· 9.2 MB",
      ...
      "cs.tag": "正式版 v1.0.0 · Windows · VST3",
      ...
      "cs.s5t": "现场也能用",
      "cs.s5d": "Low Latency 模式面向舞台与直播：歌手返听几乎察觉不到延迟。",
      "cs.s6t": "按歌曲真实的基准音高",
